...
export class BrandService {
    ...
    getBrands(): Observable<any> {
        ...
        return this.http.get<any>(`${this.url}/brands`, { params });
    }

    getBrandsList(loadRequestData: ILoadRequest): Observable<any> {
        let params = new HttpParams();
    ...
    updateBrand(brand: IBrand): Observable<any> {
        return this.http.put<any>(`${this.url}/brands/${brand._id}`, brand);
    }

    deleteBrand(brand: IBrand): Observable<any> {
        return this.http.delete<any>(`${this.url}/brands/${brand._id}`);
    }
