...
@Injectable()
export class ClearOnExitRequestsStatusGuard implements CanDeactivate<boolean> {
	...
	canDeactivate(
		...
		const validRoutes: string[] = [
			...
			'/app/payments',
			'/app/requests',
			'/app/requests/sign/status',
			'/app/requests/reject/status',
			'/app/requests/cancel/status'
		];
